...
/*int	main(void)
{
	...
	chars = ft_printf("Caracter: %c, cadena: %s, puntero: %p, decimal: %d, 
			entero: %i, sin signo: %u, hexadecimal min: %x, hexadecimal may: 
			%X y porcentaje: %%.\n", 'A', "Hola mundo", &n, -12345, 67890, 
			-42U, 305441741, 305441741);
	realchars = printf("Caracter: %c, cadena: %s, puntero: %p, decimal: %d, 
			entero: %i, sin signo: %u, hexadecimal min: %x, hexadecimal may: 
			%X y porcentaje: %%.\n", 'A', "Hola mundo", &n, -12345, 67890, 
			-42U, 305441741, 305441741);
